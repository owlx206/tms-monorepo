...
import { signDiscordVerificationState, verifyDiscordVerificationState, discordApiUrl, discordFrontendUrl } from '../../infrastructure/auth/discord-oauth.js';
...
export class LinkTeacherDiscordUseCase {
  constructor(
