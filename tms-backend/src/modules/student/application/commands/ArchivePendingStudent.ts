...
import type { ArchivePendingStudentCommand } from '../../contracts/types.js';

export class ArchivePendingStudent implements UseCase<ArchivePendingStudentCommand, StudentSummary> {
  constructor(
